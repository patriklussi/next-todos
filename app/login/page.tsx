  ...
  return (
    <div className="min-h-screen  md:h-screen  justify-center items-center flex w-screen flex-wrap  ">
      ...
      <section className="h-full flex-1  ">
        ...
        <p className="text-center my-2">Please log into your Workday account</p>
        <form className="p-4 max-w-2xl my-auto ">
          <div>
            <label>Email</label>
            <input
          ...
          <div>
            ...
            <input className="block w-full p-2 my-2 border-2" type="password" />
            <div className="flex justify-between">
              ...
              <Link className="hover:text-activeBlue hover:underline text-sm" href="#">
                Forgot password?
              </Link>
            </div>
          </div>
